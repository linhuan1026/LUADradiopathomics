...
def main(i):
    ...
    num_of_group =i
    # rename model's name!
    this_model_name = "only_cca_0319_0410"
    iswatershed = False
    if iswatershed==True:
    ...
    Predicted_path = '/home/cheng/workspace/hover_net-CCA_v0/metric_MoNuSAC/pred_results_groups_no_watershed_only_cca_0319_0410_uint16_tif/group_' + str(i)  # Path to read predicted outcomes from
...
if __name__ == "__main__":
    # 在这里使用多进程
    process_list = []
    for i in range(1, 17):  # 开启10个子进程执行函数
