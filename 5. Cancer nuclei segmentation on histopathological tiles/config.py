...
class Config(object):
    ...
    def __init__(self):
        ...
        self.train_dir_list = [
            "/home/cheng/workspace/hover_net-author_0729/hover_net-master/dataset/training_data/consep/train"
        ]
        self.valid_dir_list = [
            "/home/cheng/workspace/hover_net-author_0729/hover_net-master/dataset/training_data/consep/val"
        ]
