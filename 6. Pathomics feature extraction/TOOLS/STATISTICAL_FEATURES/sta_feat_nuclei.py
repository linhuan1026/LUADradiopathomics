...
def sta_charcter_calculation(sample1_path, N, center):
...
if __name__ == '__main__':
    ...
    # 所有需要修改的参数：开始 
    # CSV_PATH = '/home/hero/DISK_14T/DATA/实验结果/example1.2/YNCH_40x_nuclei_feat/'
    CSV_PATH = '/media/gzzstation/14TB/PyRadiomics_Results/example1B/nuclei_csv/XY2-2_save_example1B_csv/'
    
    # CSV_PATH = './nuclei_feat_test/'
    ...
    for N in NUM:
        # sta_nuclei_feat = defaultdict(list)
        print("current N:", N)
        SAVE_CSV_PATH = './'+center+'_nuclei_1k-10k'+'.csv'
        # 所有需要修改的参数：结束
        ...
        for csv_path in wsi_path:
            ...
            final_list, final_col_name = sta_charcter_calculation(cur_sample_path, N, center)
