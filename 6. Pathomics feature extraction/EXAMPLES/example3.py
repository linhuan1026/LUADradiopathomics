...
if __name__ == '__main__':
    ...
    BASE_PATH='/media/gzzstation/14TB/PyRadiomics_Data/XY2/XY2_10x'
    wsi_paths1 = os.listdir(BASE_PATH+'/')
    wsi_paths=sorted(wsi_paths1)
    length=len(wsi_paths)

    save_dir1 = '/media/gzzstation/14TB/PyRadiomics_Data/XY2/save_example3'
    os.makedirs(save_dir1, exist_ok=True)

    save_csv= save_dir1+'/XY2_10x_epi_feat_csv'
    ...
    for wsi_path in wsi_paths:
        ...
        filter = dict(type='tissue_ratio_control',
                    ...
                    select_key='Epi',
                    ignores='Background')
        img_files, color_mask_files = filter_workflow(filter, size_control=select_size)
...
############################## 
        ...
        # Step 6: save results
        save_results_csv_path = f'{save_csv}/{patient_id}_10x_epi_feat.csv'
        data = {}
        data['patient_id'] = []
        data['patch_id'] = []
